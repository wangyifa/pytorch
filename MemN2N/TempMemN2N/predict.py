...
if __name__ == '__main__':
    ...
    if opts.memn2n_type == 0:
        pred_file = open("pred_result_TempAdj_mem",'w')
        pred_a_file = open("pred_answer_TempAdj_mem",'w')
    else:
        pred_file = open("pred_result_TempLay_mem",'w')
        pred_a_file = open("pred_answer_TempLay_mem",'w')
